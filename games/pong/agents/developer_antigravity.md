...
- Pendant une tache longue (browser/config), mets a jour regulierement un fichier
  ...
  - schema minimum recommande:
    - `{"updated_at":"2026-03-27T14:52:14.073Z","task_id":"<...>","stage":"reading|planning|browser|writing|done","note":"<short>","expected_silence_ms":120000}`.
...
- JSON valide, exemple minimum:
  - `{ "status":"ack", "started_at":"2026-03-27T14:52:14.073Z", "task_id":"...", "agent":"developer_antigravity" }`
