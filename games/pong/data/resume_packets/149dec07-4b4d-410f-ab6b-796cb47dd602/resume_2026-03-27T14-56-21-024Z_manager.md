...
- reason: stop
- generated_at: 2026-03-27T14:56:21.025Z
...
Last error:
```
{"error":{"message":"{'error': '/responses: Invalid model name passed in model=None. Call `/v1/models` to view available models for your key.'}","type":"None","param":"None","code":"400"}}
```
